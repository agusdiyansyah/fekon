		...
		<div class="col-lg-12">
			<div class="box">
				<div class="box-body">
					...
					<?php echo form_hidden('id_info', set_value('id_info', isset($default['id_info']) ? $default['id_info'] : ''), 'id="id_info"');?>
					<table class='table table-condensed'>
						<tr>
							<td width='200px'>Judul Informasi</td>
							<td><?php echo form_input('title', set_value('title', isset($default['title']) ? $default['title'] : ''), 'id="title" class="form-control"');?>
							</td>
						</tr>
						<tr>
							<td>Konten</td>
								...
								<div class='col-sm-6' style="padding-left:0">
									<div class="form-group" id='datepicker'>
										<div class='input-group date' >
											<?php echo form_input('date', set_value('date', isset($default['date']) ? $default['date'] : ''), 'id="date" class="form-control" data-date-format="YYYY-MM-DD"'); ?>
